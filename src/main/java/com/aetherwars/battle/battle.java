...
public class battle {
    ...
    public void addCardToHandPlayer1(int id, CardOnHand card) {
        this.player1.add(new activeCard(id, card));
    }
    public void addCardToHandPlayer2(int id, CardOnHand card) {
    ...
    public CardOnHand getCardPlayer1(int id) {
    ...
    public CardOnHand getCardPlayer2(int id) {
    ...
    public void setCardPlayer1(int id, CardOnHand card) {
        int index = getIndexPlayer1(id);
        if (index == -1) {
            return;
        }
    ...
    public void setCardIdPlayer2(int id, CardOnHand card) {
        int index = getIndexPlayer2(id);
        if (index == -1) {
            return;
        }
    ...
    public void characterAtk(int turn, int id1, int id2) {
        ...
        CardOnHand card1=this.player1.get(index1).getCard();
        CardOnHand card2=this.player2.get(index2).getCard();
